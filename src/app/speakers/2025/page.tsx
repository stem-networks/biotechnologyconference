...
export async function generateMetadata(): Promise<Metadata> {
    try {
        ...
        const meta = generalData?.pages?.speakers_2025?.[0] || {
            title: "Speakers",
        ...
        <div>
            ...
            <div className="brand_wrap">
                <div className="auto-container">
                    <div className="row">
                        <div className="col-md-12 wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1000ms">
            ...
            <h2 className="abs_wrap5 wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1000ms">Our Speakers 2025</h2>
